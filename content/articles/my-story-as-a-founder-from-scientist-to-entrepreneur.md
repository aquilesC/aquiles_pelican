...
Tags:
  ...
  - advice
  - scipreneurs
Summary: Becoming an entrepreneur and a founder was definitely not in my plans when I started my PhD. A serendipitous trajectory pushed me to a fascinating journey.
---
...
[My PhD](https://www.aquiles.me/my-work/my-phd-thesis/ "My PhD Thesis") was focused on building new tools to study poorly understood phenomena. I think that gave me a somewhat unfair advantage, because I learned how to _make_ things. One of the early bottlenecks I had to overcome was developing software to control my setup.
...
I learned to build setups _and_ the software to control them. And software is tightly coupled to electronics, so after 4 years of work, I had developed the skills to build complex instruments from the ground up.
...
By the end of 2018, almost exactly 2 years after I’ve finished my PhD, we had managed to secure a _relatively_ small grant. But that grant had a multiplier effect: it was a pre-condition to convince an investment fund to come onboard and finance the first two years of the company.

In 2019, [we established Dispertech](https://www.aquiles.me/my-work/dispertech/ "Dispertech"). It had several shareholders, a reserve of shares for early employees, a reverse vesting strategy. The whole package: We became a real company.
...
In parallel to _product development_, you need to brush up what the incubator said about _business development_. I started building a massive library of papers from people working in areas I thought would be relevant. Some papers were very explicit regarding the limitations of other techniques.

Desk research only brings you so far. At some point the only valuable thing to do is talking to people.

While discussing with researchers, I understood that techniques claiming to be the holy grail were lagging behind in reproducibility and ease of use. Some others were claiming a resolution that was unrealistic. [I knew that if we could tackle some of those challenges, we would have a compelling product](https://www.aquiles.me/exciting-vesicles-the-field-where-biology-meets-technology/ "Exciting Vesicles – the field where biology meets technology").

By the end of 2019, the [NanoCET was ready](https://www.aquiles.me/after-a-failure-revert-to-the-last-known-working-state/ "After a Failure, Revert to the Last Known Working State"). Some people even liked the design, reminded them of Star Trek the original series.

It took around 8 months to go from registering the company in the chamber of commerce to having a _minimum viable product_ that could be demonstrated with users, brought to conferences, and that would allow us to focus on the key differentiators.

## And then what?

With a _minimum viable product_, a niche market to explore, and lots of energy, it was time to focus on growing the _business_.
...
The story on **how to go from funder to manager**, however, is [a different one](https://www.aquiles.me/how-it-feels-quitting-your-own-startup/ "How it feels quitting your own startup").